               ...
               <div class="row">
                  ...
                  <div class="col-12 col-md-6 order-md-2 order-first">
                     <nav aria-label="breadcrumb"
                        ...
                        <ol class="breadcrumb">
                           <li class="breadcrumb-item"><a href="${contextPath }/order/list">PO List</a></li>
                           <li class="breadcrumb-item active" aria-current="page">PO Detail</li>
                        </ol>
                     </nav>
                  </div>
               </div>
         ...
         <section class="section">
            <div class="card">
               <div class="card-header">
                  <h4 class="card-title mb-5">발주 상세</h4>
               </div>
               <div class="card-body">
                           ...
                           <table class="table">
                               ...
                               <tbody>
                                   <tr>
                                       ...
                                       <td>${order.company.cp_manager}</td>
                                   </tr>
                               </tbody>
                           </table>
                       </div>
                   ...
                   <table class="table">
                       ...
                       <tbody>
                           <tr>
                               ...
                               <td><fmt:formatNumber value="${order.product.p_price}" pattern="#,###"/></td>
                               <td>${order.o_qty}</td>
                               <td><fmt:formatNumber value="${order.product.p_price* order.o_qty}" pattern="#,###" /></td>
                           </tr>
                       </tbody>
                   </table>
                   <h5>비고</h5>
                   ...
                   <a href="${contextPath}/order/update?o_code=${order.o_code}" class="btn btn-outline-warning me-1 mb-1">수정</a>
							<a href="${contextPath}/order/delete?o_code=${order.o_code}"  class="btn btn-outline-danger me-1 mb-1"  
...
document.getElementById("downloadPdf").addEventListener("click", function() {
    ...
    titleDiv.innerHTML = '<h3 style="text-align: center; margin-bottom: 20px;">발주서</h3>';
    ...
    contractInfoTitle.textContent = '발주 정보';
    ...
    contractContentTitle.textContent = '비고';
