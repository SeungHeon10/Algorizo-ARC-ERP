					...
					<div class="card-body" style="width: 1000px;">
						<div class="row">
							...
							<label>계약명</label> <input type="text" name="cr_name"
								...
								<div class="form-group">
							<label>거래처명</label> <input type="text" name="contract.cp_name"
								class="form-control" value="${contract.cp_name }" readonly="readonly" />
						</div>
								<div class="form-group">
							<label>진행 상태</label> <input type="text" name="cr_state"
								...
								<div class="form-group">
							<label>담당자</label> <input type="text" name="contract.m_name"
